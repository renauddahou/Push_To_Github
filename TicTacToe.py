#source code from Coding Spot(youtube)
import numpy as np
import pygame
import math
import sys
...
# Colors
LINE_COLOR = (112,66,65)
BG_COLOR = (255,200, 124)
	...
	for col in range(BOARD_COLS):
		for row in range(BOARD_ROWS):
			if board[row][col] == 1:
				...
				pygame.draw.line(screen, X_COLOR, (col * SQUARE_SIZE + OFFSET, row * SQUARE_SIZE + SQUARE_SIZE - OFFSET), 
